...
class PoseDetector extends Detector {
    ...
    detect(imageData) {
        return new Promise((resolve, reject) => {
            ...
            this._detectPoses(imageData, timestamp).then(detected => {
                this._result = detected;
                console.log(`this._result of pose: `, this._result);
